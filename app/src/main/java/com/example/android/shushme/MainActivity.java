...
public class MainActivity extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener {
    ...
    private static final int PERMISSION_FINE_LOCATION = 254;

    // Member variables
    private PlaceListAdapter mAdapter;
    private RecyclerView mRecyclerView;
    private CheckBox mLocationPermission;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mLocationPermission = findViewById(R.id.location_permission_checkbox);
    ...
    protected void onResume() {
        ...
        boolean hasPermission = ActivityCompat.checkSelfPermission(this, ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_GRANTED;
        mLocationPermission.setChecked(hasPermission);
        mLocationPermission.setEnabled(!hasPermission);
    }
